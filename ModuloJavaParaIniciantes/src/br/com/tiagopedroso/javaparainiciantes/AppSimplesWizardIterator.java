...
public class AppSimplesWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public AppSimplesWizardIterator() {
    }

    public static AppSimplesWizardIterator createIterator() {
        return new AppSimplesWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
            new AppSimplesWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(AppSimplesWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
